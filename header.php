	...
	<header id="masthead" class="site-header">
        <div class="container container-special">
            <div class="row align-items-center align-items-lg-baseline site-header-components">
                ...
                <div class="col-auto">
                    <div id="site-header-icon"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><img src="<?php rodionov_theme_the_asset('assets/images/ava-3.png'); ?>" width="66" height="66"></a></div>
                </div>
