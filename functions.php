...
if ( ! function_exists( 'rodionov_theme_setup' ) ) :
	...
	function rodionov_theme_setup() {
		...
		register_nav_menus( array(
            ...
            'menu-1-additional' => esc_html__( 'Header Additional', 'rodionov-theme' ),
		) );
 ...
 */
function rodionov_theme_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'rodionov-theme' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'rodionov-theme' ),
...
add_action( 'widgets_init', 'rodionov_theme_widgets_init' );
